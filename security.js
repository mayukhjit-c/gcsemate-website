...
(function() {
    ...
    function runSecurityChecks() {
        ...
        console.log('%cCopyright © 2026 Mayukhjit Chakraborty', 'color: #6b7280; font-size: 12px;');
        ...
        window.GCSEMateSecurity = {
            ...
            authorized: true,
            copyright: '© 2026 Mayukhjit Chakraborty',
            notice: 'This software is protected by copyright. Unauthorized use is prohibited.'
        };
    }

    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', runSecurityChecks, { once: true });
    } else {
        runSecurityChecks();
    }
